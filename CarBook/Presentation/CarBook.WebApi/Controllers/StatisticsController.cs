...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByKmSmallerThenTousand")]
        public async Task<IActionResult> GetCarCountByKmSmallerThenTousand()
        {
            var value = await _mediator.Send(new GetCarCountByKmSmallerThenTousandQuery());
            return Ok(value);
        }
